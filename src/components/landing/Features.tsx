  ...
  return (
    <section className="text-center py-8" id="features">
      ...
      <div className="mt-8 mb-8">
        <Link href="https://www.aptosfaucet.com/" target="_blank" className="mx-8 mt-4 mb-4 inline-block">
          <Button className="bg-orange-500 hover:bg-gray-500 focus-visible:outline-orange-500 p-6 round-btn">
            <p>FAUCET</p>
            <Coins className="ml-2 h-4 w-4" />
          </Button>
        </Link>
        <Link href="https://jsmaxi.gitbook.io/shogun" passHref target="_blank" className="mx-8 mt-4 mb-4 inline-block">
